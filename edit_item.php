  ...
  <div id="container">
    ...
    <table width="83%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="131" height="37">
          <a href="javascript:void(0)" onclick="toggle_visibility('popup-box1')"><input type="button" id="btnadd"
    ...
    <div id="footer">
      <table border="0" cellpadding="15px" align="center" ;
        ...
        <tr>
          <td>
            &copy; 2024 Japanese Food | Diseñado para la materia de INF 133
          </td>
        </tr>
      </table>
    </div>
      ...
      <div id="popup-wrapper1">
        <div id="popup-container1">
          <div id="popup-head-color1">
            <br>
            <p style="font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif;font-size:16px;"> Editar Producto
            </p>
          </div>
          ...
          <form action="" method="POST">
            <table border="0" align="center">
              ...
              <tr>
                ...
                <td><input type="text" id="txtbox" name="name" placeholder="Nombre" value="<?php echo $row['name']; ?>"
                    required><br></td>
              </tr>

              <tr>
                <td align="right">Cantidad:</td>
                <td><input type="text" id="txtbox" name="quantity" placeholder="Cantidad"
                    value="<?php echo $row['quantity']; ?>" required><br></td>
              </tr>

              <tr>
                <td align="right">Precio de Compra:</td>
                <td><input type="text" id="txtbox" name="purchase" placeholder="Precio de Compra"
                    value="<?php echo $row['purchase']; ?>" required><br></td>
              </tr>

              <tr>
                <td align="right">Precio Venta:</td>
                <td><input type="text" id="txtbox" name="retail" placeholder="Precio Venta"
                    value="<?php echo $row['retail']; ?>" required><br></td>
              </tr>
              ...
              <tr align="center">
                ...
                <td>
                  <br>
                  <input type="SUBMIT" name="update" id="btnnav" value="Actualizar">
          </form>
          <a href="products.php"><input type="button"
    ...
    <tr>
      <td>
        <table border="0" cellpadding="0" cellspacing="0" align="center" width="80%"
          style="border:1px solid #033; color:#033;">

          <tr>
            <th colspan="7" align="center" height="55px"
              style="border-bottom:1px solid #033; background: #033; color:#FFF;"> Productos </th>
          </tr>
          ...
          while ($row = mysqli_fetch_array($result)) { ?>
            ...
            <tr align="center" height="25px;">
              ...
              <td style="border-bottom:1px solid #333;">
                ...
                <a href="edit_item.php?id=<?php echo md5($row['id']); ?>"><input type="button" value="Editar"
                    style="width:50px; height:20; color:#FFF; background:#069; border:1px solid #069; border-radius:3px;"></a>/<a
                  href="delete.php"><input type="button" value="Eliminar"
