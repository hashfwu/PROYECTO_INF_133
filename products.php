...
<head>
  ...
  <title>Productos Japanese Food</title>
</head>
        ...
        <table border="0" cellpadding="0" cellspacing="0" align="center" width="80%"
          ...
          <tr>
            <th colspan="7" align="center" height="55px"
              style="border-bottom:1px solid #033; background: #033; color:#FFF;"> Informacion de Productos
            </th>
          </tr>
            ...
            <tr align="center" style="height:25px">
              ...
              <td style="border-bottom:1px solid #333;">
                ...
                <a href="edit_item.php?id=<?php echo md5($row['id']); ?>"><input type="button" value="Editar"
                  ...
                  href="delete_item.php?id=<?php echo md5($row['id']); ?>"><input type="button" value="Eliminar"
    ...
    <div id="popup-wrapper">
      <div id="popup-container">
        <div id="popup-head-color1">
          <p style="text-align:right !important; font-family: 'Courier New', Courier, monospace;font-size:15px;"><a
        ...
        <form action="add_item.php" method="POST">
          <table border="0" align="center">
            ...
            <tr>
              ...
              <td><input type="text" id="txtbox" min="1" name="quantity" maxlength="11" placeholder="Quantity"
                  required><br></td>
            </tr>

            <tr>
              <td align="right">Precio de Compra:</td>
              <td><input type="text" id="txtbox" name="purchase" maxlength="11" placeholder="Purchase amnt"
                  required><br></td>
            </tr>
